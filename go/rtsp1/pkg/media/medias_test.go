		...
		Medias{
			{
				...
				Formats: []format2.Format{&format2.H264{
					PayloadTyp:        97,
					PacketizationMode: 1,
			...
			},
			{
				...
				Formats: []format2.Format{&format2.G711{
					MULaw: true,
				}},
			},
			{
				Type: "application",
				Formats: []format2.Format{&format2.Generic{
					PayloadTyp: 107,
				}},
			},
		},
		...
		Medias{
			{
				...
				Formats:   []format2.Format{&format2.MJPEG{}},
			},
			{
				Type:      "audio",
				Direction: DirectionRecvonly,
				Control:   "rtsp://192.168.0.1/audio",
				Formats:   []format2.Format{&format2.G711{MULaw: true}},
			},
			{
				Type:      "audio",
				Direction: DirectionSendonly,
