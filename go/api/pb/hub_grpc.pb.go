...
const (
	Controller_Control_FullMethodName = "/cams.api.hub.Controller/Control"
)
...
func (c *controllerClient) Control(ctx context.Context, opts ...grpc.CallOption) (Controller_ControlClient, error) {
	stream, err := c.cc.NewStream(ctx, &Controller_ServiceDesc.Streams[0], Controller_Control_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
const (
	Uploader_MediaUpload_FullMethodName = "/cams.api.hub.Uploader/MediaUpload"
)
...
func (c *uploaderClient) MediaUpload(ctx context.Context, opts ...grpc.CallOption) (Uploader_MediaUploadClient, error) {
	stream, err := c.cc.NewStream(ctx, &Uploader_ServiceDesc.Streams[0], Uploader_MediaUpload_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
const (
	Registrar_Register_FullMethodName = "/cams.api.hub.Registrar/Register"
)
...
const (
	Viewer_Play_FullMethodName  = "/cams.api.hub.Viewer/Play"
	Viewer_Pause_FullMethodName = "/cams.api.hub.Viewer/Pause"
)
...
func (c *viewerClient) Play(ctx context.Context, in *PlayRequest, opts ...grpc.CallOption) (*None, error) {
	out := new(None)
	err := c.cc.Invoke(ctx, Viewer_Play_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *viewerClient) Pause(ctx context.Context, in *PauseRequest, opts ...grpc.CallOption) (*None, error) {
	out := new(None)
	err := c.cc.Invoke(ctx, Viewer_Pause_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Viewer_Play_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Viewer_Play_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Viewer_Pause_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Viewer_Pause_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
