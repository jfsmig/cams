...
func (c *collectorClient) Play(ctx context.Context, opts ...grpc.CallOption) (Collector_PlayClient, error) {
	stream, err := c.cc.NewStream(ctx, &Collector_ServiceDesc.Streams[0], "/cams.proto.Collector/Play", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *collectorClient) Pause(ctx context.Context, opts ...grpc.CallOption) (Collector_PauseClient, error) {
	stream, err := c.cc.NewStream(ctx, &Collector_ServiceDesc.Streams[1], "/cams.proto.Collector/Pause", opts...)
	if err != nil {
		return nil, err
	}
...
var Collector_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cams.proto.Collector",
